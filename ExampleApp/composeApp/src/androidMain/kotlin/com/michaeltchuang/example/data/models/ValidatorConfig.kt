...
data class ValidatorConfig(
    ...
    val manager: String, // account that triggers/pays for payouts and keyreg transactions - needs to be hotwallet as node has to sign for the transactions
    val nfdForInfo: Int,
    ...
    val minEntryStake: BigInteger, // minimum stake required to enter pool - but must withdraw all if they want to go below this amount as well(!)
