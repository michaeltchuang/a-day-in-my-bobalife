...
object Constants {
    ...
    const val RETI_APP_ID_TESTNET = 673404372L
    const val TEST_ADDRESS = "FPH5SP6GXUA2CMLCMYVWWJJCTQXCNPKRR3QCAMBCQD3ILIV7FR27UIOL7M"
    const val TEST_PASSPHRASE_PART1 = "swing enrich bring novel oak gadget barely deer bottom brown where fossil can"
    const val TEST_PASSPHRASE_PART2 = "intact cactus rail pumpkin cost actual famous gauge deny pink above rubber"
